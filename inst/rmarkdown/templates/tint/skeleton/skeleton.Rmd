...
author: "JJ Allaire and Yihui Xie and Dirk Eddelbuettel"
date: "`r Sys.Date()`"
output:
  tint::tint: 
     default: TRUE
...
This variant uses the color scheme and [Roboto](https://fonts.google.com/specimen/Roboto)
fonts proposed by [envisioned css](http://nogginfuel.com/envisioned-css/) but remains
otherwise true to the [tufte](https://github.com/rstudio/tufte) package for R.
