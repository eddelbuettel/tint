...
_[tint](http://github.com/eddelbuettel/tint) is straightforward mix of the (html part of the) excellent
...
The remainder of the [tufte](https://github.com/rstudio/tufte) skeleton document follows as is.
