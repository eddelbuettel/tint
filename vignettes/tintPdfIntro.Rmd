...
## download files
latofile <- file.path(tempdir(), "tintPdfLatoPage1.pdf")
garamondfile <- file.path(tempdir(), "tintPdfGaramondPage1.pdf")
...
knitr::include_graphics(latofile, dpi = NA)
```
...
knitr::include_graphics(garamondfile, dpi = NA)
```
